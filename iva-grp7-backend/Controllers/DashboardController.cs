...
public class DashboardController : ControllerBase
{
    ...
    public async Task<int[]> GetPostsPerDay()
    {
        ...
        for (var i = 0; i < posts.Count; i++)
            ...
            {
                case 0:
                    weekdays[0] += posts[i].Count;
                    break;
                case 1:
                    weekdays[1] += posts[i].Count;
                    break;
                case 2:
                    weekdays[2] += posts[i].Count;
                    break;
                case 3:
                    weekdays[3] += posts[i].Count;
                    break;
                case 4:
                    weekdays[4] += posts[i].Count;
                    break;
                case 5:
                    weekdays[5] += posts[i].Count;
                    break;
                case 6:
                    weekdays[6] += posts[i].Count;
                    break;
            }
    ...
    public async Task<int[]> getUsersGrowth()
    {
        ...
        for (var i = 0; i < users.Count; i++)
            ...
            {
                case 0:
                    months[0] += users[i].Count;
                    break;
                case 1:
                    months[11] += users[i].Count;
                    break;
                case 2:
    ...
    public async Task<int[]> getGenderDistribution()
    {
        ...
        for (var i = 0; i < users.Count; i++)
            if (users[i].Gender != null)
            {
                ...
                {
                    case Gender.Male:
                        gender_value[0] = users[i].Count;
                        break;
                    case Gender.Female:
                        gender_value[1] = users[i].Count;
                        break;
                    case Gender.Diverse:
                        gender_value[2] = users[i].Count;
                        break;
                }
    ...
    public async Task<int> getPostsToday()
    {
        ...
        foreach (var post in posts) amount = post.Count;
    ...
    public async Task<int> getUsersGrowthToday()
    {
        ...
        foreach (var user in users) amount = user.Count;
    ...
    public async Task<int> getActiveUsersToday()
    {
        ...
        foreach (var post in posts) amount++;
